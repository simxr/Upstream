...
- **v1.5 — Polish:** richer audit data and a public, read-only contribution journey page after real usage validates the core workflow.

## Project boundaries

- No automated PR, code, comment, or issue-claim generation.
- No accounts, authentication, multi-tenancy, or backend database in v1.
