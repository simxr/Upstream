...
- **Public evidence:** Publish merged pull requests, repositories, domains, dates, and source links at `/journey/<slug>`.
...
4. The same workflow records merged PRs authored by the configured GitHub user as public contribution evidence.
...
- **v1.5 — Evidence loop:** linked PR tracking, optional client-side status sync, and a public read-only contribution journey generated from GitHub.
